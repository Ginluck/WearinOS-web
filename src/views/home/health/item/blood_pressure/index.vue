<template>
  ...
  <div class="gridmain">
      <div class="Title">{{ $t('health.bp_title1') }}</div>
      <div class="paratext">{{ $t('health.bp_desc1') }}</div>
    <div class="paratext">{{ $t('health.bp_desc2') }}</div>
    <div class="Title_minor">{{ $t('health.bp_title2') }}</div>
    <div class="paratext">{{ $t('health.bp_desc3') }}</div>
