...
<div class="gridmain">
      <div class="Title">{{ $t('evaluate.bp') }}</div>
      <div class="paratext">{{ $t('evaluate.bp_desc') }}</div>
    <div class="Title_minor">{{ $t('evaluate.bp_title') }}</div>
    <li class="paratext">{{ $t('evaluate.bp_test_desc1') }}</li>
    <li class="paratext">{{ $t('evaluate.bp_test_desc2') }}</li>
    <li class="paratext">{{ $t('evaluate.bp_test_desc3') }}</li>
