<template>
  ...
  <div class="gridmain">
      <div class="Title">{{ $t('questions.question1') }}</div>
      <div class="paratext_bot"></div>
      <li class="paratext">{{ $t('questions.answer1_1') }}</li>
      <li class="paratext">{{ $t('questions.answer1_2') }}</li>
      <li class="paratext">{{ $t('questions.answer1_3') }}</li>
  </div>
