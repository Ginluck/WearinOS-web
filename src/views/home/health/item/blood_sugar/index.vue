<template>
  ...
  <div class="gridmain">
      <div class="Title">{{ $t('health.bs_title1') }}</div>
      <div class="paratext">{{ $t('health.bs_desc1') }}</div>
    <div class="paratext">{{ $t('health.bs_desc2') }}</div>
    <div class="Title_minor">{{ $t('health.bs_title2') }}</div>
    <div class="paratext">{{ $t('health.bs_desc3') }}</div>
