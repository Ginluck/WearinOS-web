<template>
  ...
  <div class="gridmain">
      <div class="Title">{{ $t('health.p_title1') }}</div>
      <div class="paratext">{{ $t('health.p_desc1') }}</div>
    <div class="paratext">{{ $t('health.p_desc2') }}</div>
    <div class="Title_minor">{{ $t('health.p_title2') }}</div>
    <div class="paratext">{{ $t('health.p_desc3') }}</div>
