...
<div class="gridmain">
  <div class="Title">{{ $t('tools.health_remind') }}</div>
  <div class="paratext">{{ $t('tools.health_desc1') }}</div>
    <div class="paratext_bot"></div>
    <div class="Title_minor">{{ $t('tools.health_title') }}</div>
    <li class="paratext">{{ $t('tools.health_desc2') }}</li>
    <li class="paratext">{{ $t('tools.health_desc3') }}</li>
    <div class="paratext_bot"></div>
  </div>
