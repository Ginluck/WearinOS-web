...
<div class="gridmain">
  <div class="Title">{{ $t('tools.cash_card') }}</div>
  <div class="paratext">{{ $t('tools.cash_desc1') }}</div>
    <div class="paratext_bot"></div>
    <div class="Title_minor">{{ $t('tools.cash_title') }}</div>
    <li class="paratext">{{ $t('tools.cash_desc2') }}</li>
    <li class="paratext">{{ $t('tools.cash_desc3') }}</li>
    <li class="paratext">{{ $t('tools.card_desc3') }}</li>
    <div class="paratext_bot"></div>
  </div>
