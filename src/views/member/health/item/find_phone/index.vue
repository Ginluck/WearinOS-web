...
<div class="gridmain">
  <div class="Title">{{ $t('tools.find_phone') }}</div>
    <div class="paratext_bot"></div>
    <li class="paratext">{{ $t('tools.find_desc1') }}</li>
    <li class="paratext">{{ $t('tools.find_desc2') }}</li>
    <li class="paratext">{{ $t('tools.find_desc3') }}</li>
    <div class="paratext_bot"></div>
  </div>
