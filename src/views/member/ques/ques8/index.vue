<template>
  ...
  <div class="gridmain">
      <div class="Title">{{ $t('questions.question8') }}</div>
      <div class="paratext_bot"></div>
      <li class="paratext">{{ $t('questions.answer8_1') }}</li>
      <li class="paratext">{{ $t('questions.answer8_2') }}</li>
      <div class="paratext_bot"></div>
      <div class="Title_minor">{{ $t('questions.answer4_2_A') }}</div>
      <li class="paratext">{{ $t('questions.answer8_3') }}</li>
      <div class="paratext_bot"></div>
      <div class="Title_minor">{{ $t('questions.answer4_2_I') }}</div>
      <li class="paratext">{{ $t('questions.answer8_4') }}</li>
      <div class="paratext_bot"></div>
