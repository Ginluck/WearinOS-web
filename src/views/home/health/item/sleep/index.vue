<template>
  ...
  <div class="gridmain">
      <div class="Title">{{ $t('health.sleep_title1') }}</div>
      <div class="paratext">{{ $t('health.sleep_desc1') }}</div>
    <div class="paratext">{{ $t('health.sleep_desc2') }}</div>
    <div class="Title_minor">{{ $t('health.sleep_title2') }}</div>
    <div class="paratext">{{ $t('health.sleep_desc3') }}</div>
