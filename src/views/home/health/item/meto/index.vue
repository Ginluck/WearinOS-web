<template>
  ...
  <div class="gridmain">
      <div class="Title">{{ $t('health.mt_title1') }}</div>
      <div class="paratext">{{ $t('health.mt_desc1') }}</div>
    <div class="paratext">{{ $t('health.mt_desc2') }}</div>
    <div class="Title_minor">{{ $t('health.mt_title2') }}</div>
    <div class="paratext">{{ $t('health.mt_desc3') }}</div>
