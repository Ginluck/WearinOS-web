...
<div class="gridmain">
    <div class="Title">{{ $t('evaluate.pressure') }}</div>
    <div class="paratext">{{ $t('evaluate.pressure_desc') }}</div>
    <div class="Title_minor">{{ $t('evaluate.pressure_title') }}</div>
    <li class="paratext">{{ $t('evaluate.pressure_test_desc1') }}</li>
    <li class="paratext">{{ $t('evaluate.pressure_test_desc2') }}</li>
    <li class="paratext">{{ $t('evaluate.pressure_test_desc3') }}</li>
