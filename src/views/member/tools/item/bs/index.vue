...
<div class="gridmain">
    <div class="Title">{{ $t('evaluate.bs') }}</div>
    <div class="paratext">{{ $t('evaluate.bs_desc') }}</div>
    <div class="Title_minor">{{ $t('evaluate.bs_title') }}</div>
    <li class="paratext">{{ $t('evaluate.bs_test_desc1') }}</li>
    <li class="paratext">{{ $t('evaluate.bs_test_desc2') }}</li>
    <li class="paratext">{{ $t('evaluate.bs_test_desc3') }}</li>
