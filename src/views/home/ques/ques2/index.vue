<template>
  ...
  <div class="gridmain">
      <div class="Title">{{ $t('questions.question2') }}</div>
      <div class="paratext_bot"></div>
      <li class="paratext">{{ $t('questions.answer2_1') }}</li>
      <li class="paratext">{{ $t('questions.answer2_2') }}</li>
      <li class="paratext">{{ $t('questions.answer2_3') }}</li>
  </div>
