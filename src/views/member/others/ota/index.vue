...
<div class="gridmain">
    <div class="Title">{{ $t('others.ota') }}</div>
    <div class="paratext">{{ $t('others.ota_desc') }}</div>
    <div class="paratext_bot"></div>

    <li class="paratext">{{ $t('others.ota_desc1') }}</li>
    <li class="paratext">{{ $t('others.ota_desc2') }}</li>
    <div class="paratext_bot"></div>
