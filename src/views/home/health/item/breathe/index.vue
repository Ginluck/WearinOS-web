<template>
  ...
  <div class="gridmain">
      <div class="Title">{{ $t('health.br_title1') }}</div>
      <div class="paratext">{{ $t('health.br_desc1') }}</div>
    <div class="paratext">{{ $t('health.br_desc2') }}</div>
    <div class="Title_minor">{{ $t('health.br_title2') }}</div>
    <div class="paratext">{{ $t('health.br_desc3') }}</div>
