<template>
  ...
  <div class="gridmain">
      <div class="Title">{{ $t('person.person_item3') }}</div>
      <div class="paratext">{{ $t('person.person_account_desc1') }}</div>
      <div class="paratext_bot"></div>
      <div class="paratext">{{ $t('person.person_account_desc2') }}</div>
      <div class="paratext">{{ $t('person.person_account_desc3') }}</div>
      <div class="paratext_bot"></div>
