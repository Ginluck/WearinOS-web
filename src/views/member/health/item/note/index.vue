...
<div class="gridmain">
  <div class="Title">{{ $t('tools.note') }}</div>
  <div class="paratext">{{ $t('tools.note_desc1') }}</div>
    <div class="paratext_bot"></div>
    <div class="Title_minor">{{ $t('tools.note_title') }}</div>
    <li class="paratext">{{ $t('tools.note_desc2') }}</li>
    <li class="paratext">{{ $t('tools.note_desc3') }}</li>
    <div class="paratext_bot"></div>
  </div>
