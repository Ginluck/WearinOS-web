...
<div class="gridmain">
  <div class="Title">{{ $t('tools.second_clock') }}</div>
  <div class="paratext">{{ $t('tools.second_desc1') }}</div>
    <div class="paratext_bot"></div>
    <li class="paratext">{{ $t('tools.second_title') }}</li>
    <li class="paratext">{{ $t('tools.second_desc2') }}</li>
    <div class="paratext_bot"></div>
  </div>
