...
<div class="gridmain">
  <div class="Title">{{ $t('tools.time_manager') }}</div>
  <div class="paratext">{{ $t('tools.time_desc1') }}</div>
    <div class="paratext_bot"></div>
    <div class="Title_minor">{{ $t('tools.time_title') }}</div>
    <li class="paratext">{{ $t('tools.time_desc2') }}</li>
    <li class="paratext">{{ $t('tools.time_desc3') }}</li>
    <div class="paratext_bot"></div>
  </div>
